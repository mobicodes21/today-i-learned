...
async function loadFacts() {
  const res = await fetch(
    "https://slhuvateulpjoevofilr.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNsaHV2YXRldWxwam9ldm9maWxyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODExMDU0NzAsImV4cCI6MjA5NjY4MTQ3MH0.ehnQjj7yyzFcx7jzQZqdigK-nHtn71XdU--PjVz9bIg",
      },
    },
  );
